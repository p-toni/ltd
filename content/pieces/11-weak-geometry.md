...
mood:
  - exploratory
  - analytical
excerpt: Why owned structure must stay less committed than I want it to.
pinned: true
watch_queries:
  - weakest hypothesis generalization Bennett
  - optimal policy weakest policy Bennett
  - chord arpeggio co-instantiation consciousness bound
watch_domains:
  - preprints.org
  - arxiv.org
